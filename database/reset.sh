...
load database
     from https://raw.githubusercontent.com/openpolitica/jne-elecciones/main/data/plataformaelectoral/2021-candidatos-congresales.db
...
command_file="$(cat << EOF
load database
     from https://raw.githubusercontent.com/openpolitica/jne-elecciones/main/data/plataformaelectoral/2021-candidatos-parlamento-andino.db
     into pgsql://${PGUSER}@${PGHOST}:${PGPORT}/${PGDATABASE}
...
command_file="$(cat << EOF
load database
     from https://raw.githubusercontent.com/openpolitica/jne-elecciones/main/data/infogob/2021-militancia-candidatos-congresales.db
     into pgsql://${PGUSER}@${PGHOST}:${PGPORT}/${PGDATABASE}
...
command_file="$(cat << EOF
load database
     from https://raw.githubusercontent.com/openpolitica/jne-elecciones/main/data/infogob/2021-militancia-candidatos-parlamento-andino.db
     into pgsql://${PGUSER}@${PGHOST}:${PGPORT}/${PGDATABASE}
